...
By downloading, installing, or using EVPoly ("the Software"), you agree to be bound by these Terms of Service. If you do not agree, do not use the Software.
...
THE SOFTWARE IS PROVIDED "AS IS" AND "AS AVAILABLE," WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO THE WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, ACCURACY, COMPLETENESS, OR NON-INFRINGEMENT.

The developers make no warranty that the Software will be uninterrupted, error-free, secure, or free of bugs, vulnerabilities, or defects. No oral or written information provided by the developers creates any warranty.

## 3. Risk Acknowledgment

By using the Software, you acknowledge and accept that:

- Cryptocurrency and prediction market trading is inherently risky and speculative.
- Automated trading strategies can result in rapid and total loss of funds.
- Market conditions, smart contract failures, API outages, network congestion, oracle errors, and software bugs may cause unexpected losses.
- Past performance of any strategy does not guarantee future results.
- You may lose some or all of the funds you commit to trading.

You represent that you understand these risks and are willing to accept them.

## 4. Limitation of Liability

TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, THE DEVELOPERS, CONTRIBUTORS, AND COPYRIGHT HOLDERS SHALL NOT BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR EXEMPLARY DAMAGES, INCLUDING BUT NOT LIMITED TO:

- Financial or trading losses of any kind
- Loss of profits, data, or goodwill
- Damages arising from smart contract failures or blockchain issues
- Damages arising from third-party API failures (including Polymarket)
- Damages arising from software bugs, errors, or downtime
- Damages arising from unauthorized access to your wallet or private keys

This limitation applies regardless of the legal theory (contract, tort, negligence, strict liability, or otherwise), even if the developers have been advised of the possibility of such damages.

## 5. Not Financial Advice

The Software is a tool. Nothing in the Software, its documentation, or any associated communication constitutes financial advice, investment advice, trading advice, or any other form of professional advice. The developers are not financial advisors, licensed brokers, or registered investment professionals.
...
**By using EVPoly, you confirm that you have read, understood, and agreed to these Terms of Service.**
